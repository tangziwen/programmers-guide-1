...
The implementation of shooting block
...
We use setCcdMotionThreshold & setCcdSweptSphereRadius  to set the threshold and radius to trigger the Ccd method.
